...
#
# This file was generated from the source file cop_EG.xml
...
package DateTime::Locale::cop_EG;
...
DateTime::Locale::cop_EG

=head1 SYNOPSIS

  use DateTime;

  my $dt = DateTime->now( locale => 'cop_EG' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Coptic Egypt.
