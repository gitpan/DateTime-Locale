...
#
# This file was generated from the source file cop_US.xml
...
package DateTime::Locale::cop_US;
...
DateTime::Locale::cop_US

=head1 SYNOPSIS

  use DateTime;

  my $dt = DateTime->now( locale => 'cop_US' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Coptic United States.
