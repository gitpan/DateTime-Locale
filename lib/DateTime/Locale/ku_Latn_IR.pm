...
#
# This file was generated from the source file ku_Latn_IR.xml
...
package DateTime::Locale::ku_Latn_IR;
...
DateTime::Locale::ku_Latn_IR

=head1 SYNOPSIS

  use DateTime;

  my $dt = DateTime->now( locale => 'ku_Latn_IR' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Kurdish Latin Iran.
