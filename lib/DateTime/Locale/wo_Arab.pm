...
#
# This file was generated from the source file wo_Arab.xml
...
package DateTime::Locale::wo_Arab;
...
DateTime::Locale::wo_Arab

=head1 SYNOPSIS

  use DateTime;

  my $dt = DateTime->now( locale => 'wo_Arab' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Wolof Arabic.
