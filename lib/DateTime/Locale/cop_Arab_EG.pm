...
#
# This file was generated from the source file cop_Arab_EG.xml
...
package DateTime::Locale::cop_Arab_EG;
...
DateTime::Locale::cop_Arab_EG

=head1 SYNOPSIS

  use DateTime;

  my $dt = DateTime->now( locale => 'cop_Arab_EG' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Coptic Arabic Egypt.
