...
#
# This file was generated from the source file und_ZZ.xml
...
package DateTime::Locale::und_ZZ;

use strict;
use warnings;
use utf8;

use base 'DateTime::Locale::und';
...
DateTime::Locale::und_ZZ

=head1 SYNOPSIS

  use DateTime;

  my $dt = DateTime->now( locale => 'und_ZZ' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Unknown or Invalid Language Unknown or Invalid Region.

=head1 DATA

This locale inherits from the L<DateTime::Locale::und> locale.
