...
{
    my $month_format_abbreviated = [ "çil", "sib", "adr", "nîs", "gul", "hez", "tîr", "8", "9", "10", "11", "12" ];
...
{
    my $month_format_wide = [ "çile", "sibat", "adar", "nîsan", "gulan", "hezîran", "7", "8", "9", "10", "11", "12" ];
...
{
    my $month_stand_alone_narrow = [ "ç", "s", "a", "n", "g", "h", "7", "8", "9", "10", "11", "12" ];
