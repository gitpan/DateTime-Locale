...
#
# This file was generated from the source file cop_Arab.xml
...
package DateTime::Locale::cop_Arab;

use strict;
use warnings;
use utf8;

use base 'DateTime::Locale::cop';
...
DateTime::Locale::cop_Arab

=head1 SYNOPSIS

  use DateTime;

  my $dt = DateTime->now( locale => 'cop_Arab' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Coptic Arabic.

=head1 DATA

This locale inherits from the L<DateTime::Locale::cop> locale.
