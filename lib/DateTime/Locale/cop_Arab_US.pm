...
#
# This file was generated from the source file cop_Arab_US.xml
...
package DateTime::Locale::cop_Arab_US;

use strict;
use warnings;
use utf8;

use base 'DateTime::Locale::cop_Arab';
...
DateTime::Locale::cop_Arab_US

=head1 SYNOPSIS

  use DateTime;

  my $dt = DateTime->now( locale => 'cop_Arab_US' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Coptic Arabic United States.

=head1 DATA

This locale inherits from the L<DateTime::Locale::cop_Arab> locale.
