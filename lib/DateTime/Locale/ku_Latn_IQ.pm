...
#
# This file was generated from the source file ku_Latn_IQ.xml
...
package DateTime::Locale::ku_Latn_IQ;
...
DateTime::Locale::ku_Latn_IQ

=head1 SYNOPSIS

  use DateTime;

  my $dt = DateTime->now( locale => 'ku_Latn_IQ' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Kurdish Latin Iraq.
