...
#
# This file was generated from the source file und.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'und' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Unknown or Invalid Language.
