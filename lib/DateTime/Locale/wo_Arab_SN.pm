...
#
# This file was generated from the source file wo_Arab_SN.xml
...
package DateTime::Locale::wo_Arab_SN;

use strict;
use warnings;
use utf8;

use base 'DateTime::Locale::wo_Arab';
...
DateTime::Locale::wo_Arab_SN

=head1 SYNOPSIS

  use DateTime;

  my $dt = DateTime->now( locale => 'wo_Arab_SN' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Wolof Arabic Senegal.

=head1 DATA

This locale inherits from the L<DateTime::Locale::wo_Arab> locale.
